...
identity_filter = zeros(filter_size);
identity_filter(fix(filter_size/2)+1,fix(filter_size/2)+1) = 2;
...
filter = ones(filter_size) * 1/(filter_size*filter_size);
filter = minus(identity_filter, filter);
